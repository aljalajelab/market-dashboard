...
START_YEAR=2003; W_SHORT=21; W_LONG=50; BREADTH_MA=10; MIN_UNIVERSE_FRAC=0.60
...
def download_close(all_tickers, start_year):
    ...
    if df.empty: raise SystemExit("فشل.")
...
def compute_breadth(close_wide, universes, min_frac):
    ...
    cond = ma_s > ma_l; valid = (~ma_s.isna()) & (~ma_l.isna())

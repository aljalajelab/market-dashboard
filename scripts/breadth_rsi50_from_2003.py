# breadth_rsi50_from_2003.py — يحفظ data/rsi50.csv
import os, time
...
START_DATE="2003-01-01"; RSI_PERIOD=14; THRESHOLD=50; BATCH_SIZE=50; PAUSE_SEC=1.0
...
def main():
    ...
    percent.name="RSI50_Breadth"
    out=percent.to_frame(); out.index.name="Date"
    out.to_csv(DATA_DIR/"rsi50.csv")
    print(f"✅ rsi50.csv — آخر قيمة: {percent.dropna().iloc[-1]:.2f}")
